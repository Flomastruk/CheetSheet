...
\begin{theorem}
	...
	\begin{equation*}
		\sqrt{n}(\hat{\theta_n} - \theta) \rightarrow N(0, i_\theta^{-1})
	\end{equation*}
\end{theorem}

\begin{theorem}\label{cramerraobound}
